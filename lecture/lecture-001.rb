...
puts "Enter a number?"
a = gets
a = a.to_i #converts string to integer, equivalent to a = parseInt(a);

puts "Enter a floating point number?"
b = gets
b = b.to_f #converts string to floating point number
...
if age < 5 #parenthesis is optional
	puts "You are a baby"
elsif (age >= 5) && (age < 18)
...
puts "Enter a letter"
letter = gets.chomp #removes an added line from a string
